...
public:
    ...
    virtual void mostrarMenu() const {
        ...
        cout << endl;
        imprimirSeparadorRojoBlanco(40);
        cout << " >>> Total de productos : " << productos.gettamano() << endl;
    ...
    void mostrarPorCategoria(const string& categoria) const {
        ...
        for (int i = 0; i < productosFiltrados.gettamano(); i++) {
        ...
        imprimirSeparadorRojoBlanco(40);
        cout << ">>> Total de productos en la categoria: " << productosFiltrados.gettamano() << endl;
    }
    ...
    int getTotalProductos() const { return productos.gettamano(); }
